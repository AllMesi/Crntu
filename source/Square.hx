...
class Square extends FlxState
{
	 ...
	 */
	public static function setupWindow(isTrueBorderless:Bool, isTrueFullscreen:Bool, isTrueWindow:Bool, isTrueWindowMax:Bool, fullscreenFirst:Bool = true,
			cacheSound:Bool = true)
	{
		FlxG.sound.cacheAll();
